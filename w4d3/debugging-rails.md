...
Therefore to debug them, we make use of our good friend: the Ruby
debugger.
...
If you need a refresher on Debugger, be sure to have a look over the
previous readings:
...
inside of the ruby debugger to get a list of commands that are
available for use.
